...
card.addEventListener("click", (e)=>{
  e.preventDefault();
 alert("this card is clicked"+item.id)
 

  localStorage.setItem("data",JSON.stringify({"title":item.title,"category":item.category,"image":item.image,"price":item.price,"rate":item.rating.rate,"count":item.rating.count}))
